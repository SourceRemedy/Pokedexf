...
public class Pokedexf {
    ...
    public static void main(String[] args) {
        ...
        String[][] data = {
            ...
            { "Exposure to sunlight adds to its strength. Sunlight a;so makes the bud on its back grow larger." },
            { "This pokemon is a grass and poison type. By spreading the broad petals of its flower and catching the sun's rays, it fills its body with power." },
            ...
            { "It often hides in water to stalk unwary prey. For last swimming, it moves its ears to maintain balance." },
            { "The pressurized water jets on this brutal Pokemon's shell are used for high-speed tackles." },
            { "It is covered with green skin. When it grows, it sheds the skin, covers itself with silk, and becomes a cocoon." },
            { "Its shell os hard as an iron slab. A Metapod does not move very much because its preparing its soft innards for evolution inside the shell." },
            { "Its wings are covered in toxic scales. If it finds bird pokemon going after Caterpie, Butterfree sprinkles its scales on them to drive them off." },
            { "Its poison stinger is very powerful. Its bright-colored body is intended to ward off its enemies." },
            ...
            { "It's so stinky! Muks body contains toxic elements, and any plant will wilt when it passes by." },
           ...
           { "It looks just like a Poke Ball. It is dangerous because it may electrocute or explode on contact." },
           ...
           { "Mew is said to possess the genetic composition of all pokemon. It is capable of making itself invisible at will, so it entirely avoids notice ven if it approaches people." },
        }; 
